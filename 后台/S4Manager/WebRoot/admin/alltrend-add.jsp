	...
	<div class="main">
		...
		<div class="manage">
			<form action="/S4Manager/Trends.action" method="post" onsubmit="return cheksub('maxAge','chekAge','zm','chekZm')">
				<input type="hidden" name="op" value="addtrends"/>
				<table class="form">
				<tr><td>动态消息标题</td><td><input type="text" id="maxAge" name="maxAge"  onblur="cheknull('maxAge','chekAge')"/><div id="chekAge" >${mea }</div></td></tr>
				<tr><td>动态消息内容</td><td><textarea id="zm" name="zm"  onblur="cheknull('zm','chekZm')"></textarea><div id="chekZm" style="display: none;"></div></td></tr>
				...
				<tr><td>动态消息头图片</td><td ><div align="center" style="height:200;border:5px solid red; " id="fa1">动态消息头图片</div><div style=" height:0px; overflow:hidden; position:absolute;" ><input type="file" id="filePath" name="filePath" onchange="fileupload('filePath','fa1','ttp')"/></div>
