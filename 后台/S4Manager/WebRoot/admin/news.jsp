...
{
alert("删除成功")
window.location.href="<%=basePath%>Trends.action?op=shownewslist"
}
else
{
alert("删除失败")}
		...
		<div style="width:750px; height:600px; overflow:scroll;">
			<table class="list">
				...
				<tr>
					...
					<td class="w1 c"><a href="Trends.action?op=upnews&tid=${trends.value.tr_id }">修改</a> <a onclick=" udelete(${trends.value.tr_id})">删除</a></td>
				</tr>
