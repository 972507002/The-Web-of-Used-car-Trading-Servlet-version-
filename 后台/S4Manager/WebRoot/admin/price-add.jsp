	...
	<div class="main">
		...
		<div class="manage">
			<form action="/S4Manager/Model.action" method="post" onsubmit="return chesub('minAge','maxAge','万','cAge','chekAge')">
				<input type="hidden" name="op" value="addprice"/>
				<table class="form">
				<tr><td>最小车价</td><td><input type="text" id="minAge" name="minAge" onblur="chekSubMit('minAge','maxAge','万','cAge','chekAge')" /></td></tr>
				<tr><td>最大车价</td><td><input type="text" id="maxAge" name="maxAge"  onblur="chekSubMit('minAge','maxAge','万','cAge','chekAge')"/><div id="chekAge" >${mea }</div></td></tr>
