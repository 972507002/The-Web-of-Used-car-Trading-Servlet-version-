	...
	<div class="main">
		...
		<div class="manage">
			<form action="/S4Manager/Model.action" method="post" onsubmit="return chekSub()">
				...
				<table class="form">
				<tr><td>车型名</td><td><input type="text" id="maxAge" name="maxAge"  onblur="chek()"/><div id="chekAge" >${mea }</div></td></tr>
				...
				<tr><td>车型Logo</td><td ><div align="center" style="height:200;border:5px solid red; " id="fa1">车型logo图片</div><div style=" height:0px; overflow:hidden; position:absolute;" ><input type="file" id="filePath" name="filePath" onchange="fileupload('filePath','fa1','ttp')"/></div>
