	...
	<div class="main">
		...
		<div class="manage">
			<form action="/S4Manager/Model.action" method="post" onsubmit="return cheksub()">
				<input type="hidden" name="op" value="tjemsi"/>
				<input type="hidden" name="eid" value="${emsi.e_id }"/>
				<table class="form">
				<tr><td>排放标准名称:</td><td><input type="text" id="name" value="${emsi.e_name }" name="name" /><div id="dea" >${mea }</div></td></tr>
				<tr><td>热度</td><td colspan="4"><input type="text" id="count"  value="${emsi.e_count }" name="count" onblur="chekCount()" /><div id="d2" style="display: none;"></div></td><td></td></tr>
