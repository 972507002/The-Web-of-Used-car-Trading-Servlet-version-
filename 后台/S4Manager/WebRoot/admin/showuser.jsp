...
<div id="main" class="wrap">
	...
	<div class="main">
		...
		<c:if test="${!empty info }">
                            ...
                            <tr align="center"><td colspan="2" >姓名：</td><td   >${info.u_name }</td><td></td></tr>
                            <tr align="center"><td colspan="2">手机：</td><td>${info.u_tel}</td><td></td></tr>
                            <tr align="center"><td colspan="2">QQ：</td><td><c:if test="${info.u_qq!=0 }">${info.u_qq}</c:if><c:if test="${info.u_qq==0 }"></c:if></td><td></td></tr>
                            <tr align="center"><td colspan="2">Email：</td><td>${info.u_email }</td><td></td></tr>
                            <tr  align="center"><td colspan="2">性别：</td><td colspan="5">${info.u_sex }</td></tr>
                                                        <tr  align="center"><td colspan="2" align="center">地址：</td><td colspan="5">${info.u_adr }</td></tr>
