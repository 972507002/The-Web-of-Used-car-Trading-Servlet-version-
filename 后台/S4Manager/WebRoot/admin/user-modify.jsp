...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改用户</h2>
		<div class="manage">
			<form action="MgUsIn.action"  method="post"    onsubmit="return cheksubmit()">
			<input type="hidden" name="op" value="update" />
				...
				<input type="hidden" name="getuser" id="getuser" value="1"></input>
					...
					<tr>
						...
						<td><input type="text" class="text" name="mobile" id="mobile" value="${getuser.u_tel }" disabled="disabled" onblur="checkphone()"/>
						<div  id="phonediv" style="display:none"></div>
						</td>
					</tr>
					<tr>
						<td class="field">姓名：</td>
						<td><input type="text" class="text" name="realname" id="realname" value="${getuser.u_name }" onblur="chekName()" size="5"/>
					...
					<tr>
						...
						<div  id="d4" style="display:none"></div></td>
							...
							<c:if test="${ getuser.u_qq>0}">
						<td><input type="text" class="text" name="qq" id="qq" value="${getuser.u_qq }" onblur="chekqq()"/><div  id="d4" style="display:none"></div></td>
						
						</c:if>
					</tr>
					<tr>
						<td class="field">邮箱：</td>
						<td><input type="text" class="text" name="email" id="email" value="${getuser.u_email }" onblur="chekemail()"/>
					...
					<tr>
						...
						<div  id="d2" style="display:none"></div>
							...
							<c:if test="${ getuser.u_card>0}">
						<td><input type="text" class="text" name="card" id="card" value="${getuser.u_card }" onblur="chekCard()"/>
							<div  id="d2" style="display:none"></div>
						</td>
						</c:if>
					...
					<tr>
						<td><input type="hidden" id="uid" name="uid" value="${getuser.u_id }"/></td>
