    ...
    <div class="a-wb">
      <div class="wrap">
        ...
        <div class="a-div">
          ...
          <li class="clearfix"> 
              <a href="CarInfo.action?op=showdetails&cid=${trends.c_id }&uid=${trends.u_id}" target="_blank">
              <div class="img left dInline"> <img width="338" height="221" src="${ trends.c_img }"  /> </div>
              <div class="con right dInline">
                <div class="ne_tit clearfix">
                  <h2 class="left dInline"> ${trends.c_brand }${trends.c_series }${trends.c_releaseyear }款 ${trends.c_volume }T ${trends.c_gearType } ${trends.c_code } ${trends.c_model } </h2>
                  <span class="right"> 点击量:${ trends.c_count }</span> </div>
                <p>${ trends.c_czzx }</p>
