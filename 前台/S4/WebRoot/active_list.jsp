    ...
    <div class="a-wa">
      <div class="wrap a-nav">
        <ul class="clearfix">
          ...
          <li><a href="Trends.action?op=showcom">客户留言</a></li>
          <li class="on"><a href="Trends.action?op=showactive">活动中心</a></li>
    ...
    <div class="a-wb">
      <div class="wrap">
        ...
        <div class="a-div">
          ...
          <li class="clearfix"> 
              <a href="Trends.action?op=showteia&tr_id=${trends.value.tr_id }" target="_blank">
              <div class="img left dInline"> <img width="338" height="221" src="${ trends.value.tr_img }"  /> </div>
              <div class="con right dInline">
                <div class="ne_tit clearfix">
                  <h2 class="left dInline"> ${ trends.value.tr_title } </h2>
                  <span class="right"> ${ trends.value.tr_date } </span> </div>
                <p>${ trends.value.tr_text }</p>
           ...
           <div class="pages"> <c:if test="${curPage > 1}">
					<a href="Trends.action?op=showactive&jumpPage=1&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">首页</a>&nbsp;&nbsp;&nbsp;
		 		<a href="Trends.action?op=showactive&jumpPage=${curPage - 1}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">上一页</a>
				</c:if> <c:if test="${curPage <= 1}">
			 		首页&nbsp;&nbsp;&nbsp;上一页
		 		</c:if> &nbsp;&nbsp;&nbsp; <c:if test="${curPage < maxPage}">
					<a href="Trends.action?op=showactive&jumpPage=${curPage + 1}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">下一页</a>
		 			&nbsp;&nbsp;&nbsp;
		 			<a href="Trends.action?op=showactive&jumpPage=${maxPage}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">尾页</a>
				</c:if> <c:if test="${curPage >= maxPage}">
					下一页
		 			&nbsp;&nbsp;&nbsp;尾页		 		
		 		</c:if>
