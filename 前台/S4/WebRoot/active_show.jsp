...
<div id="about">
	<div class="mTags wrap">
		<a href="CarInfo.action?op=show">亿金名车广场</a>><a href="Trends.action?op=showactive">活动中心</a>><a >${_trends.tr_title }</a>
	</div>
				...
				<div class="a-div" style="padding-bottom:30px">
					<div class="news_detail">
						...
						<div class="news_p">
							...
							<a href="Trends.action?op=showactive" class="backList">返回列表</a>
						</div>
					</div>
				</div>
			</div>
