      ...
      <c:if test="${time>12 }">
        ...
        <div class="mr-detail">
          <div class="mr-tab clearfix"> <a href="MemberCenter.action?op=showmenberYbcar">我购买的车</a> 
            <!--<a>售后历史</a>-->
            <a class="on"  href="MemberCenter.action?op=showmenberXj">我下架的车</a> 
          ...
          <div class="me-box me-box1">
           ...
           <div class="me-dl"  style="display:block;">
							...
							</p><div class="price clearfix" style="margin:5px 0;"><div class="left dInline pNum">	<font>一口价</font><br/><span class="num nBlue">${szCar.value.c_price}</span><font> 万元</font>			 </div>				 				</div>		<div class="cs_bt clearfix">						<a href="MemberCenter.action?op=showmenberSj&uid=${szCar.value.u_id}&cid=${szCar.value.c_id}">上架</a>		</div>	</div></li></ul><div class="hPages">    </div>
							</c:forEach>
							</c:if>
								</div>
								 <div class="pages"> <c:if test="${curPage > 1}">
					<a href="MemberCenter.action?op=showmenberXj&jumpPage=1">首页</a>&nbsp;&nbsp;&nbsp;
		 		<a href="MemberCenter.action?op=showmenberXj&jumpPage=${curPage - 1}">上一页</a>
				</c:if> <c:if test="${curPage <= 1}">
			 		首页&nbsp;&nbsp;&nbsp;上一页
		 		</c:if> &nbsp;&nbsp;&nbsp; <c:if test="${curPage < maxPage}">
					<a href="MemberCenter.action?op=showmenberXj&jumpPage=${curPage + 1}">下一页</a>
		 			&nbsp;&nbsp;&nbsp;
		 			<a href="MemberCenter.action?op=showmenberXj&jumpPage=${maxPage}">尾页</a>
				</c:if> <c:if test="${curPage >= maxPage}">
					下一页
		 			&nbsp;&nbsp;&nbsp;尾页		 		
		 		</c:if>
