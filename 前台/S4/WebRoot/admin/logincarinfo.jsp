...
alert("留言失败")}
  ...
  <div class="top">
    <div class="wrap clearfix"> <a href="#" class="logo left"><img src="images/logo.png"/></a>
      ...
      <a class="on" href="MemberCenter.action?op=needmaiche">我要卖车</a>
...
<div id="about">
  ...
  </c:if></a> <span class="right">对这辆车不满意，我要 <a href="#">私人订制</a></span> </div>
  <div class="wrap">
    <div class="buyDetail">
      <div class="b_tab_nav">
        <div class="b-tab"> <a class="on b_ta" href="#cBox1" data-scroll data-speed="1000">基本信息<i></i></a> <a href="#cBox3" data-scroll data-speed="1000" class="b_ta">图片赏析<i></i></a> <!--<a href="../../../../../Apply/Index/channel/5/id/2.html#jisuanqi">贷款计算器<i></i></a>--> <span style="float:right;font-size:14px;color: #2e71b8; margin-right:30px;"><b>看车电话：销售部 (400-888-666)</b></span> </div>
      </div>
      <div class="b-cont">
          ...
          <h2>${brad }${cx }${cxi }</h2>
           <div class="ca-dl"> <span class="caItem on">展示图片</span>
              ...
              <div style="width:1150px; height:267px; overflow:scroll;">
                <table width="1026px"  >
                  <tr >
           <td ><div align="center" style="height:200;border:5px solid red; " id="fa1"><br><br><br>*必选(展示车的全外观)</div><div style=" height:0px; overflow:hidden; position:absolute;" ><input type="file" id="filePath" name="filePath" onchange="fileupload('filePath','fa1','ttp')"/></div>
           <input type="button" onclick="document.getElementById('filePath').click();" value="上传"></td>
...
<form name="upform" action="MemberCenter.action" method="post"  onsubmit="return chekSub('carxh','carxxx','dis','div8','cartype','div6','carbh','carbbb','stan','div9','travel','divf','price','priiii','speed','speeee','ytime','div2','ytime1','div3','data','divf1','duedate','divf3','key','keyyy','numm','nummmm','sate','sateaa')">
