  ...
  <a class="bottom_a next_a" style="opacity: 0.7; "></a> 
    ...
    <div class="buyTxt right dInline">
      ...
      <div class="byDl clearfix">
        ...
        <c:if test="${detailsMap.value.newprice!=0 }">
        <div class="right dInline jPrice" style="line-height:22px;"> 新车价:${detailsMap.value.newprice }万<br/>
          <span>为您节省:${detailsMap.value.newprice-detailsMap.value.c_price }万</span><br/>
          <!--<a id="dBtn" style="display:block;" href="#showdiv"> <img src="images/btn1.png" width="18" /> 计算分期详情 </a> --></div></c:if>
        <c:if test="${ detailsMap.value.newprice==0 }">
        <div class="right dInline jPrice" style="line-height:22px;"> 新车价:专业人员为您评估中<br/>
          <span>为您节省:专业人员为您评估中</span><br/>
          <!--<a id="dBtn" style="display:block;" href="#showdiv"> <img src="images/btn1.png" width="18" /> 计算分期详情 </a> --></div></c:if>
      </div>
      ...
      <div class="byBtn clearfix"> 
        <div class="jiathis_style_32x32"> ${xiaoxi }</div>
        <!--<a href="#">置换</a>--> 
      ...
      <c:if test="${detailsMap.value.c_state=='在售' }">
      <div class="byBtn clearfix"> <c:if test="${!empty userinfo }"><a  onclick="sendDg(${detailsMap.value.c_id },${detailsMap.value.u_id },'needdg')" >立即抢定</a> </c:if><a href="CarInfo.action?op=showCompare&uid=${detailsMap.value.u_id }&cid=${detailsMap.value.c_id }" class="balance_2">加入对比</a>
        <div class="jiathis_style_32x32"> <c:if test="${!empty userinfo }"><a onclick="sendSc(${detailsMap.value.c_id },${detailsMap.value.u_id })"  class="jiathis " style="text-decoration:none; text-align:center;display:inline-block;height:35px;  margin-right:12px">收藏</a> </c:if></div>
        <!--<a href="#">置换</a>--> 
       ...
       <c:if test="${detailsMap.value.c_state!='在售' }">
        <div class="byBtn clearfix">该车已被订购或已下架或已经卖出或在审核中或未通过审核,不再提供购买和加入对比和收藏功能
        <div class="jiathis_style_32x32"></div>
        <!--<a href="#">置换</a>--> 
