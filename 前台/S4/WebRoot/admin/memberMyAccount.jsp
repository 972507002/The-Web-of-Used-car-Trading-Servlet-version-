...
<div id="about">
	<div class="mTags wrap">
		<a href="index.jsp">亿金名车广场</a>><a href="menber.jsp">会员中心</a>><a>账户管理</a>
	</div>
	<div class="mebBox">
				...
				<div class="mr-detail">
					...
					<div class="me-box me-box1">
						...
						<div class="me-dl" style="display:block;">
							<div class="me-one">
								<div class="accForm">
									<form action="UserInfo.action"   method="post" onsubmit="return cheksubmit()">
										...
										<div class="afl clearfix">
											...
											<div class="af-r left dInline">
												<input type="text" class="ar-txt" name="mobile" placeholder="请输入手机号码" value="${userinfo.u_tel }" disabled="disabled" />
											</div>
										</div>
										<div class="afl clearfix">
											<label class="left">
											...
											<div class="af-r left dInline">
												<input type="text" class="ar-txt" name="realname" id="realname" placeholder="请输入您的姓名" value="${userinfo.u_name }" onblur="chekName()"/>
										...
										<div class="afl clearfix">
											...
											<div class="af-r left dInline">
											<c:if test="${userinfo.u_card!=0 }">
										<input type="text" class="ar-txt" name="card" id="card" placeholder="请输入您的身份证" value="${userinfo.u_card }" onblur="chekCard()"/>
											</c:if>
											<c:if test="${userinfo.u_card==0 }">
										...
										<div class="afl clearfix">
											...
											<div class="af-r left dInline">
												<input type="text" class="ar-txt" name="adr" id="adr" placeholder="请输入您的地址" value="${userinfo.u_adr }" />
										...
										<div class="afl clearfix">
											...
											<div class="af-r left dInline">
											 <c:if test="${userinfo.u_qq!=0 }">
											<input type="text" class="ar-txt" name="qq" id="qq" placeholder="请输入您的QQ"  value="${userinfo.u_qq }" onblur="chekqq()" />
											 </c:if>
											  <c:if test="${userinfo.u_qq==0 }">
										...
										<div class="afl clearfix">
											...
											<div class="af-r left dInline">
												<input type="text" class="ar-txt" name="email" id="email" placeholder="请输入您的邮箱" value="${userinfo.u_email}" onblur="chekemail()" />
                        ...
                        <div class="me-dl" >
							<div class="me-one">
								<div class="accForm">
									<form action="UserInfo.action"  name="editP" method="post" onsubmit="return cheksub();">
				...
				<div class="mr-detail">
					...
					<div class="me-box me-box1">
                        ...
                        <div class="me-dl"  style="display:block;">
							<div class="me-one">
								<div class="accForm">
									<form action="UserInfo.action"   method="post" onsubmit="return cheksub();">
										 <input type="hidden" name="op" value="updatepwd">
										<div class="afl clearfix">
											<label class="left">
												当前密码
