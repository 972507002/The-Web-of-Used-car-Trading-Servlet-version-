...
alert("留言失败")}
  ...
  <div class="top">
    <div class="wrap clearfix"> <a href="#" class="logo left"><img src="images/logo.png"/></a>
      <div class="nav left dInline" id="headerMenu"> <a  href="CarInfo.action?op=show">首页</a> <a href="about.jsp">关于亿金</a> <a href="CarInfo.action?op=showlist">我要买车</a> <a href="MemberCenter.action?op=needmaiche">我要卖车</a> <a  class="on" href="CarInfo.action?op=showsrdz">私人定制</a> 
