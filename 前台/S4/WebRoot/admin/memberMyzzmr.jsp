            ...
            <p>
				...
				<div class="mr-detail">
					<div class="mr-tab clearfix">
					    ...
					    <a  class="on" href="MemberCenter.action?op=showmenberzzmr" >申请取消买入的车</a>
					</div>
					<div class="me-box">
					  <div class="me-dl"></div>
		           <div class="me-dl"></div>
		          ...
		          <div class="me-dl"></div>
					 <div class="me-dl"  style="display:block;">
							...
							排放标准：${szCar.value.c_emissionstandard}</span>
								...
								卖家或买家发起了终止交易申请,我们会马上联系卖家和买家双方进行审核	</div>	</div></li></ul><div class="hPages">    </div>
							</c:forEach>
							</c:if>
								</div>
								 <div class="pages"> <c:if test="${curPage > 1}">
					<a href="MemberCenter.action?op=showmenberzzmr&jumpPage=1">首页</a>&nbsp;&nbsp;&nbsp;
		 		<a href="MemberCenter.action?op=showmenberzzmr&jumpPage=${curPage - 1}">上一页</a>
				</c:if> <c:if test="${curPage <= 1}">
			 		首页&nbsp;&nbsp;&nbsp;上一页
		 		</c:if> &nbsp;&nbsp;&nbsp; <c:if test="${curPage < maxPage}">
					<a href="MemberCenter.action?op=showmenberzzmr&jumpPage=${curPage + 1}">下一页</a>
		 			&nbsp;&nbsp;&nbsp;
		 			<a href="MemberCenter.action?op=showmenberzzmr&jumpPage=${maxPage}">尾页</a>
				</c:if> <c:if test="${curPage >= maxPage}">
					下一页
		 			&nbsp;&nbsp;&nbsp;尾页		 		
		 		</c:if>
