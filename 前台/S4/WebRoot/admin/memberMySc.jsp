...
<div id="about">
	<div class="mTags wrap">
		<a href="index.jps">亿金名车广场</a>><a href="menber.jsp">会员中心</a>><a>我的需求</a>
	</div>
	<div class="mebBox">
		<div class="meb-cont clearfix wrap">
			<div class="meb-nav left dInline">
				<ul class="clearfix">
                    ...
                    <li class="on"><a href="MemberCenter.action?op=showmenberOrder">我的需求</a></li>
                    <li><a href="MemberCenter.action?op=showmenberYbcar">我的车</a></li>
            ...
            <p>
				...
				<div class="mr-detail">
					<div class="mr-tab clearfix">
						<a href="MemberCenter.action?op=showmenberOrder">我的订单</a>
						<a href="MemberCenter.action?op=showsrdz">私人订制</a>
						<a  href="MemberCenter.action?op=showmenberMc">出售中的车</a>
						<a href="MemberCenter.action?op=showmenberSh">审核中的车</a>
                        <a class="on" href="MemberCenter.action?op=showmenberSc">我收藏的车型</a>
										    <a   href="MemberCenter.action?op=showmenberzzmr" >申请取消买入的车</a>
		         ...
		         <div class="me-dl"></div>
                        <div class="me-dl"  style="display:block;">
							...
							</p><div class="price clearfix" style="margin:5px 0;"><div class="left dInline pNum">	<font>一口价</font><br/><span class="num nBlue">${szCar.value.c_price}</span><font> 万元</font>			 </div>			<span class="num1 left" style="height:43px;padding-top:10px;"><em>新车价：${szCar.value.newprice }万元</em><br/>				为您节省：${szCar.value.newprice-szCar.value.c_price }万元 						</span>		</div>		<div class="cs_bt clearfix">			<a onclick="sendDg(${szCar.value.c_id },${szCar.value.u_id },'needdg')" class="cs-q">立即抢订</a>			<a href="MemberCenter.action?op=qxsc&uid=${szCar.value.u_id}&cid=${szCar.value.c_id}">取消收藏</a>		</div>	</div></li></ul><div class="hPages">    </div>
							</c:forEach>
							</c:if>
								</div>
								 <div class="pages"> <c:if test="${curPage > 1}">
					<a href="MemberCenter.action?op=showmenberSc&jumpPage=1">首页</a>&nbsp;&nbsp;&nbsp;
		 		<a href="MemberCenter.action?op=showmenberSc&jumpPage=${curPage - 1}">上一页</a>
				</c:if> <c:if test="${curPage <= 1}">
			 		首页&nbsp;&nbsp;&nbsp;上一页
		 		</c:if> &nbsp;&nbsp;&nbsp; <c:if test="${curPage < maxPage}">
					<a href="MemberCenter.action?op=showmenberSc&jumpPage=${curPage + 1}">下一页</a>
		 			&nbsp;&nbsp;&nbsp;
		 			<a href="MemberCenter.action?op=showmenberSc&jumpPage=${maxPage}">尾页</a>
				</c:if> <c:if test="${curPage >= maxPage}">
					下一页
		 			&nbsp;&nbsp;&nbsp;尾页		 		
		 		</c:if>
