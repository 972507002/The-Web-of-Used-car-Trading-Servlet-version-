...
<title><c:if test="${!empty detailsMap }">
  ...
  ${detailsMap.value.c_brand } ${detailsMap.value.c_series }${detailsMap.value.c_releaseyear } 款 ${detailsMap.value.c_volume }T ${detailsMap.value.c_gearType } ${detailsMap.value.c_code } ${detailsMap.value.c_model }
  </c:forEach>
	...
	<div id="header">
		<div class="top">
			<div class="wrap clearfix">
				<a href="#" class="logo left"><img src="images/logo.png" />
				</a>
				<div class="nav left dInline" id="headerMenu">
					<a href="CarInfo.action?op=show">首页</a> <a href="about.jsp">关于亿金</a>
					<a href="CarInfo.action?op=showlist">我要买车</a> <a class="on"
						href="MemberCenter.action?op=needmaiche">我要卖车</a> <a
						href="CarInfo.action?op=showsrdz">私人定制</a>
					<!--<a href="shfw.html">售后服务</a>-->
					<c:if test="${!empty userinfo }">
						<a id="MemberMenuChange" href="MemberCenter.action?op=showmenber"
							target="_self">会员中心</a>
					</c:if>
					<c:if test="${empty userinfo }">
						<a id="MemberMenuChange" onclick="sendLogin()">会员中心</a>
					</c:if>
				</div>
				<span class="right" id="rightMenuHtml"> <c:if
						test="${empty userinfo }">
						<a onclick="sendLogin()">登录</a>|<a onclick="sendReg()">注册</a>|&nbsp;&nbsp;&nbsp;&nbsp;<img
							src="images/tel.png" />
					</c:if> <c:if test="${!empty userinfo }">
						<c:if test="${time<12 }">上午好！</c:if>
						<c:if test="${time>=12 }">  下午好！ </c:if>
						<a href="MemberCenter.action?op=showmenber">
							${userinfo.u_name } </a>|<a
							href="UserInfo.action?op=zhuxiao&url=CarInfo.action?op=show">注销</a>|&nbsp;&nbsp;&nbsp;&nbsp;<img
							src="images/tel.png" />
					</c:if> </span>
			</div>
		</div>
		<div class="head-search">
			<div class="wrap clearfix">
				<div class="yjxj clearfix left" action="/index/keyword/"
...
#jShow {
	...
	<div id="about">
		<div class="mTags wrap">
			<a href="#">亿金名车广场</a>><a href="#">我要买车</a>><a href="#"><c:if
					test="${!empty detailsMap }">
					<c:forEach var="detailsMap" items="${detailsMap }">
  ${detailsMap.value.c_brand } ${detailsMap.value.c_series }${detailsMap.value.c_releaseyear } 款 ${detailsMap.value.c_volume }T ${detailsMap.value.c_gearType } ${detailsMap.value.c_code } ${detailsMap.value.c_model }
  </c:forEach>
				</c:if>
			</a> <span class="right"> <a href="#"></a>
			</span>
		</div>
		<div class="wrap">
			<div class="buyDetail">
				<div class="b_tab_nav">
					<div class="b-tab">
						<a class="on b_ta" href="#cBox1" data-scroll data-speed="1000">基本信息<i></i>
						</a> <a href="#cBox3" data-scroll data-speed="1000" class="b_ta">图片赏析<i></i>
						</a>
						<!--<a href="../../../../../Apply/Index/channel/5/id/2.html#jisuanqi">贷款计算器<i></i></a>-->
						<span
							style="float:right;font-size:14px;color: #2e71b8; margin-right:30px;"><b>看车电话：销售部
								(400-888-666)</b>
						</span>
					</div>
				</div>
				<div class="b-cont">
					<div id="cBox1" class="c_box">
						<h2>${car.c_brand}${car.c_series }${car.c_type }</h2>
						<div class="ca-dl">
							<span class="caItem on">展示图片</span>
							<div class="clearfix">
								<div style="width:1150px; height:267px; overflow:scroll;">
									<table width="1026px">
										<tr>
											<td><div align="center"
													style="height:200;border:5px solid red; " id="fa1">
													<img src=${car.c_img }>
												</div>
												<div
													style=" height:0px; overflow:hidden; position:absolute;">
													<input type="file" id="filePath" name="filePath"
														onchange="fileupload('filePath','fa1','ttp')" />
												</div> <input type="button"
												onclick="document.getElementById('filePath').click();"
												value="上传">
											</td>
											<td><div align="center"
											
													style="height:200;border:5px solid red; " id="fa2">
													<c:if test="${!empty k1 }">
													...
													<c:if test="${empty k1 }">
														<br>
														<br>
														<br>图片越多越容易引人关注哦</c:if>
												</div>
												<div
													style=" height:0px; overflow:hidden; position:absolute;">
													<input type="file" id="filePath1" name="filePath1"
														onchange="fileupload('filePath1','fa2','ftp1')" />
												</div> <input type="button"
												onclick="document.getElementById('filePath1').click();"
												value="上传">
											</td>
											<td><div align="center"
													style="height:200;border:5px solid red; " id="fa3">
													<c:if test="${!empty k2}">
														<img src="${k2 }">
													</c:if>
													<c:if test="${empty k2 }">
												...
												<div
													style=" height:0px; overflow:hidden; position:absolute;">
													<input type="file" id="filePath2" name="filePath2"
														onchange="fileupload('filePath2','fa3','ftp2')" />
												</div> <input type="button"
												onclick="document.getElementById('filePath2').click();"
												value="上传">
											</td>
											<td><div align="center"
													style="height:200;border:5px solid red; " id="fa4">
													<c:if test="${!empty k3 }">
														<img src="${k3 }">
													</c:if>
													<c:if test="${empty k3 }">
												...
												<div
													style=" height:0px; overflow:hidden; position:absolute;">
													<input type="file" id="filePath3" name="filePath3"
														onchange="fileupload('filePath3','fa4','ftp3')" />
												</div> <input type="button"
												onclick="document.getElementById('filePath3').click();"
												value="上传">
											</td>
											<td><div align="center"
													style="height:200;border:5px solid red; " id="fa5">
													<c:if test="${!empty k4 }">
														<img src="${k4}">
													</c:if>
													<c:if test="${empty k4 }">
												...
												<div
													style=" height:0px; overflow:hidden; position:absolute;">
													<input type="file" id="filePath4" name="filePath4"
														onchange="fileupload('filePath4','fa5','ftp4')" />
												</div> <input type="button"
												onclick="document.getElementById('filePath4').click();"
												value="上传">
											</td>
											<td><div align="center"
													style="height:200;border:5px solid red; " id="fa6">
													<c:if test="${!empty k5 }">
														<img src="${ k5} ">
													</c:if>
													<c:if test="${empty k5 }">
												...
												<div
													style=" height:0px; overflow:hidden; position:absolute;">
													<input type="file" id="filePath5" name="filePath5"
														onchange="fileupload('filePath5','fa6','ftp5')" />
												</div> <input type="button"
												onclick="document.getElementById('filePath5').click();"
												value="上传">
											</td>
						...
						<form name="upform" action="MemberCenter.action" method="post"
							onsubmit="return chekSub('carxh','carxxx','dis','div8','cartype','div6','carbh','carbbb','stan','div9','travel','divf','price','priiii','speed','speeee','ytime','div2','ytime1','div3','data','divf1','duedate','divf3','key','keyyy','numm','nummmm','sate','sateaa')">
							<input type="hidden" name="op" value="uptj"> 
							<input type="hidden" name="cid" value="${car.c_id }">
							<input
								type="hidden" name="brad" value="${car.c_brand }"> <input
								type="hidden" name="cx" value="${car.c_series }"> <input
								type="hidden" name="cxi" value="${car.c_type}"> <input
								type="hidden" name="ttp" value="${car.c_img }"> <input type="hidden"
								name="ftp1" value="${k1 }"> <input type="hidden" name="ftp2" value="${k2 }">
							<input type="hidden" name="ftp3" value="${k3 }"> <input type="hidden"
								name="ftp4" value="${k4 }"> <input type="hidden" name="ftp5" value="${k5 }">
							<div class="cbox-a">
								<div class="ca-table">
									<table>
										<tr>
											<td class="ca-td1">上牌时间</td>
											<td><input placeholder="*必选" class="for_datetime cPut"
												data-date-format="yyyy-mm" type="text" id="stime"
												name="stime" value="${car.c_licencetime }"
												onblur="chekspz()" />
												<div id="div1" style="display:none"></div></td>
											<td class="ca-td1">年检到期时间</td>
											<td><input type="text" class="for_datetime cPut"
												value="${bas.aidd }" data-date-format="yyyy-mm"
												placeholder="*必填" id="ytime" name="ytime"
												onblur="chekbxsj('ytime','div2')" />
												<div id="div2" style="display:none"></div></td>
											<td class="ca-td1">强险到期时间</td>
											<td><input type="text" class="for_datetime cPut"
												value="${bas.srdt }" data-date-format="yyyy-mm"
												placeholder="*必填" id="ytime1" name="ytime1"
												onblur="chekbxsj('ytime1','div3')" />
												<div id="div3" style="display:none"></div></td>
											<td class="ca-td1">型号</td>
											<td><input type="text" placeholder="*必填(如领先型,时尚型等)"
												value="${car.c_model }" id="carxh" name="carxh"
												onblur="cheknull('carxh','carxxx')" />
												<div id="carxxx" style="display:none"></div></td>
										</tr>
										<tr>
											<td class="ca-td1">车身颜色</td>
											<td><input type="text" placeholder="非必填"
												value="${bas.bodyColor }" id="carcolor" name="carcolor"
												onblur="checkColor()" />
												<div id="div5" style="display:none"></div></td>
											<td class="ca-td1">车体形式</td>
											<td><input type="text" placeholder="*必填(小型,大型,房车等)"
												value="${car.c_type }" id="cartype" name="cartype"
												onblur="cheknull('cartype','div6')" value="${cxi }" />
												<div id="div6" style="display:none"></div></td>

											<td class="ca-td1">排量(T)</td>
											<td><input type="text" placeholder="*必填(限正整数或一位小数)"
												value="${car.c_volume }" id="dis" name="dis"
												onblur="chekpail('dis','div8')" />
												<div id="div8" style="display:none"></div></td>
											<td class="ca-td1">编号</td>
											<td><input type="text" placeholder="*必填(如730li等)"
												value="${car.c_code }" id="carbh" name="carbh"
												onblur="cheknull('carbh','carbbb')" />
												<div id="carbbb" style="display:none"></div></td>
										</tr>
										<tr>
									...
									<div class="clearfix">
										...
										<table>
											<tr>
												...
												<td><input type="text" placeholder="*必填(国三,国四,国五等)"
													value="${car.c_emissionstandard }" id="stan" name="stan"
													onblur="cheknull('stan','div9')" />
													<div id="div9" style="display:none"></div></td>
												...
												<td><input type="text" id="travel" name="travel"
													placeholder="*必填(限8以下正整数或一位小数)" value="${car.c_distance }"
													onblur="chekywxs('travel','divf')" />
													<div id="divf" style="display:none"></div></td>
											</tr>
											...
											<tr>
												...
												<td><input type="text" placeholder="非必填"
													value="${bas.interiorColor }" id="carincolor"
													name="carincolor" onblur="checkCarin()" />
													<div id="divy" style="display:none"></div></td>

												<td class="ca-td1">出厂日期</td>
												<td><input type="text" placeholder="*必填"
													class="for_datetime cPut" data-date-format="yyyy-mm"
												value="${bas.domf }"	id="data" name="data" onblur="chekbxsj('data','divf1')" />
													<div id="divf1" style="display:none"></div></td>
											</tr>
											...
											<tr>
												...
												<td><input type="text" placeholder="非必填" id="area"
												value="${bas.orgin }"	name="area" onblur="checkArea" />
													<div id="divf2" style="display:none"></div></td>

												<td class="ca-td1" width="270">商业险到期日</td>
												<td><input type="text" placeholder="*必填"
													class="for_datetime cPut" data-date-format="yyyy-mm"
												value="${bas.cimd }"	id="duedate" name="duedate"
													onblur="chekbxsj('duedate','divf3')" />
													<div id="divf3" style="display:none"></div></td>
											</tr>
											...
											<table>
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad1" name="rad1" checked
																value="有" />有
														</div>
														<div class="right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad2" name="rad2" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad3" name="rad3" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad4" name="rad4" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad5" name="rad5" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad6" name="rad6" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad7" name="rad7" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad8" name="rad8" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad9" name="rad9" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad0" name="rad0" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-1" name="rad-1" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad-2" name="rad-2" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-3" name="rad-3" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad-4" name="rad-4" checked
																value="有" />有
														</div>
														<div class="rad right">
										...
										<div class="jb_infor right">
											<table>
												<tr>
													...
													<td><input type="text" placeholder="*必选"
														value="${car.c_releaseyear }" class="form_datetime cPut"
														data-date-format="yyyy" id="fxn" name="fxn"
														onblur="chekYear()" />
														<div id="fxnnn" style="display: none"></div></td>
												</tr>
												<tr>
													<td width="270" class="ca-td1">座位数</td>
													<td><input type="text" id="sate" name="sate"
												value="${hard.seatNumber }"		placeholder="*必填" onblur="ckzs('sate','sateaa')" />
														<div id="sateaa" style="display: none"></div></td>
												</tr>

												<tr>
													<td width="270" class="ca-td1">燃料形式</td>
													<td><input type="text" id="fuel" name="fuel"
												value="${hard.fuelForm }"		placeholder="非必填" /></td>
												</tr>
												<tr>
													<td class="ca-td1">变速箱</td>
													<td><input placeholder="*必填(AT自动,手动等)" type="text"
													value="${hard.cvt }"	id="speed" name="speed"
														onblur="cheknull('speed','speeee')" />
														<div id="speeee" style="display: none"></div></td>
												</tr>
												<tr>
													<td class="ca-td1" width="270">驱动方式</td>
													<td><input type="text" value="${hard.drivingMethod }"  id="method" name="method"
														placeholder="非必填" /></td>
												</tr>
												<tr>
													<td class="ca-td1">无钥匙进入</td>
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-key" name="rad-key" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad-5" name="rad-5" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-6" name="rad-6" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad-7" name="rad-7" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-8" name="rad-8" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad-9" name="rad-9" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-qtf" name="rad-qtf" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="rad-htf" name="rad-htf" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-0" name="rad-0" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td>
														<div class="rad left">
															<input type="radio" id="rad-hjy" name="rad-hjy" checked
																value="有" />有
														</div>
														<div class="rad right">
								...
								<div class="ca-dl">
									<span class="caItem on">手续信息</span>
									<div class="clearfix">
										<div class="jb_infor left">
											<table>
												<tr>
													<td class="ca-td1" width="270">购置税</td>
													<td><input type="text" placeholder="非必填"  value="${proce.purchaseTax }" id="buy"
														name="buy" /></td>
												</tr>
												<tr>
													<td class="ca-td1">行驶证</td>
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-a" name="rad-a" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td><div class="rad left">
															<input type="radio" id="xczb" name="xczb" checked
																value="有" />有
														</div>
														<div class="rad right">
												...
												<tr>
													...
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-b" name="rad-b" checked
																value="有" />有
														</div>
														<div class="rad right">
										...
										<div class="jb_infor right">
											<table>
												<tr>
													...
													<td><input type="text" placeholder="*必填" id="numm"
													value="${proce.transferTimes }"	name="numm" onblur="ckzs('numm','nummmm')" />
														<div id="nummmm" style="display: none"></div></td>
												</tr>

												<tr>
													<td class="ca-td1">钥匙（把）</td>
													<td><input type="text" placeholder="*必填" id="key"
													value="${proce.key }"	name="key" onblur="ckzs('key','keyyy')" />
														<div id="keyyy" style="display: none"></div></td>
												</tr>
												<tr>
													<td width="270">新车发票</td>
													<td><div class="rad left">
															<input type="radio" id="rad-c" name="rad-c" checked
																value="有" />有
														</div>
														<div class="rad right">
								...
								<div class="ca-dl">
									<span class="caItem on">销售信息</span>
									<div class="clearfix">
										<div class="jb_infor left">
											<table>
												<tr>
													<td width="270" class="ca-td1">销售价(万元)</td>
													<td><input placeholder="*限6位以下正整数或两位小数" type="text"
														id="price" name="price" onblur="chekpri('price','priiii')"
														value="${car.c_price }" />
														<div id="priiii" style="display: none"></div></td>
												</tr>
												<tr>
													<td class="ca-td1">含过户费</td>
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-d" name="rad-d" checked
																value="是" />是
														</div>
														<div class="rad right">
										...
										<div class="jb_infor right">
											<table>
												<tr>
													...
													<td><input type="text" placeholder="非必填" id="p-type"
													value=${sell.priceType }	name="p-type" /></td>
												</tr>
												<tr>
													<td class="ca-td1">支持分期</td>
													<td class="ca-td1"><div class="rad left">
															<input type="radio" id="rad-f" name="rad-f" checked
																value="是" />是
														</div>
														<div class="rad right">
								...
								<div class="ca-dl">
									<span class="caItem on">详细描述</span>
									<div class="clearfix">
										<table>
											<tr>
												<td colspan="8"><textarea id="txta" name="txta"
		...
		<div class="popForm">
			<div class="p-detail">
				<form action="" enctype="multipart/form-data" method="post"
					onsubmit="return popYzm();" name="yzmcheck" id="yzmcheck">
					<ul class="login-items" style="width:100%">
						<li><label>手机号</label> <input type="text" value=""
							maxlength="32" name="mobile" style="width:120px"> <input
							type="checkbox" style=" width:auto; margin:10px 20px 0" value="1"
							name="ckmobile" /> <label>记住此号</label></li>
						<li><label>验证码</label> <input type="text" value=""
							maxlength="16" name="verify"
							style="width:120px; margin-right:20px;"> <img
							src="../../../../../Admin/Login/buildVerify.html" id="yzcode"
							width="100" height="42" alt="点击切换"
							onclick="this.src='../../../../../Admin/Login/buildVerify.html'">
						</li>
					</ul>
					<div class="login-button">
						<input type="hidden" value="" name="sta" id="stames" /> <input
							type="hidden" value="2" name="carid" id="caridmes" /> <input
							type="button" value="立即提交" class="fM"
							onclick="$('#yzmcheck').submit()" style="line-height:20px" />
					</div>
				</form>
			</div>
			<a class="closed">×</a>
    ...
    <div class="wrap clearfix">
      ...
      <div class="fDl left dInline fDl1">
		...
		<div class="foot-b">
			Copyright © 2015 qcauto All Rights Reserved 河南亿金有限公司 版权所有
			豫ICP备13013744号-1<br /> 地址：郑州市金水区花园北路与天伦路交汇处东50米路南 服务热线：400-033-7777<br />
		</div>
	</div>
<!--右侧内容的开始-->
<c:if test="${!empty userinfo }">
