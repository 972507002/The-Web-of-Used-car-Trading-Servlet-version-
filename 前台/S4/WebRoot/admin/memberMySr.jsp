            ...
            <p>
				...
				<div class="mr-detail">
					<div class="mr-tab clearfix">
						...
						<a class="on" href="MemberCenter.action?op=showsrdz">私人订制</a>
		           ...
		           <div class="me-dl"></div>
					...
					<a href="MemberCenter.action?op=showsrdz&jumpPage=1">首页</a>&nbsp;&nbsp;&nbsp;
		 		<a href="MemberCenter.action?op=showsrdz&jumpPage=${curPage - 1}">上一页</a>
				</c:if> <c:if test="${curPage <= 1}">
			 		首页&nbsp;&nbsp;&nbsp;上一页
		 		</c:if> &nbsp;&nbsp;&nbsp; <c:if test="${curPage < maxPage}">
					<a href="MemberCenter.action?op=showsrdz&jumpPage=${curPage + 1}">下一页</a>
		 			&nbsp;&nbsp;&nbsp;
		 			<a href="MemberCenter.action?op=showsrdz&jumpPage=${maxPage}">尾页</a>
				</c:if> <c:if test="${curPage >= maxPage}">
					下一页
		 			&nbsp;&nbsp;&nbsp;尾页		 		
		 		</c:if>
