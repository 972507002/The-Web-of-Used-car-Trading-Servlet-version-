    ...
    <div class="a-wb">
      <div class="wrap">
        ...
        <div class="a-div">
          ...
          <li class="clearfix"> 
              <a href="CarInfo.action?op=showlist&bname=${trends.c_brand }" target="_blank">
              <c:forEach var="tenBrand" items="${ tenBrand}">
              <c:if test="${ tenBrand.b_name==trends.c_brand}">
                            <div class="img left dInline"> <img width="338" height="221" src="${ tenBrand.b_img }"  /> </div>
              
              </c:if>
              </c:forEach>
              <div class="con right dInline">
                <div class="ne_tit clearfix">
                  <h2 class="left dInline"> ${  trends.c_brand } </h2>
                  <span class="right">销量: ${ trends.c_count } </span> </div>
                <p></p>
