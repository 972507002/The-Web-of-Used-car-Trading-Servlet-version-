...
<div id="about">
  <div class="mTags wrap"> 
  	<a href="CarInfo.action?op=show">亿金名车广场</a>><a >亿金动态</a> </div>
  <div class="wAbout">
    <div class="a-wa">
    ...
    <div class="a-wb">
      <div class="wrap">
        ...
        <div class="a-div">
          ...
          <li class="clearfix"> 
              <a href="Trends.action?op=showtei&tr_id=${trends.value.tr_id }" target="_blank">
           ...
           <div class="pages"> <c:if test="${curPage > 1}">
					<a href="Trends.action?op=shownewslist&jumpPage=1">首页</a>&nbsp;&nbsp;&nbsp;
		 		<a href="Trends.action?op=shownewslist&jumpPage=${curPage - 1}">上一页</a>
				</c:if> <c:if test="${curPage <= 1}">
			 		首页&nbsp;&nbsp;&nbsp;上一页
		 		</c:if> &nbsp;&nbsp;&nbsp; <c:if test="${curPage < maxPage}">
					<a href="Trends.action?op=shownewslist&jumpPage=${curPage + 1}">下一页</a>
		 			&nbsp;&nbsp;&nbsp;
		 			<a href="Trends.action?op=shownewslist&jumpPage=${maxPage}">尾页</a>
				</c:if> <c:if test="${curPage >= maxPage}">
					下一页
		 			&nbsp;&nbsp;&nbsp;尾页		 		
		 		</c:if>
