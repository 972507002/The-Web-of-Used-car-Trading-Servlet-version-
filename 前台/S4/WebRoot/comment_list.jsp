...
<div id="about">
  <div class="mTags wrap">
  	<a href="CarInfo.action?op=show">亿金名车广场</a>><a >客户留言</a>
   </div>
  <div class="wAbout">
    <div class="a-wa">
      <div class="wrap a-nav">
        <ul class="clearfix">
          ...
          <li><a class="on" href="Trends.action?op=showcom">客户留言</a></li>
          <li ><a href="Trends.action?op=showactive">活动中心</a></li>
          <li ><a  href="Trends.action?op=shownewslist">亿金动态</a></li>
    ...
    <div class="a-wb">
      <div class="wrap">
        ...
        <div class="a-div">
          ...
          <li class="clearfix"> 
              <a href="Trends.action?op=showcomd&cid=${trends.value.cid }" target="_blank">
              <div class="img left dInline"> <img width="338" height="221" src="${ trends.value.c_img }"  /> </div>
              <div class="con right dInline">
                <div class="ne_tit clearfix">
                  <h2 class="left dInline"> ${ trends.value.c_text } </h2>
                  <span class="right"> ${ trends.value.c_date } </span> </div>
                <p>${trends.value.c_text }</p>
           ...
           <div class="pages"> <c:if test="${curPage > 1}">
					<a href="Trends.action?op=showcom&jumpPage=1&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">首页</a>&nbsp;&nbsp;&nbsp;
		 		<a href="Trends.action?op=showcom&jumpPage=${curPage - 1}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">上一页</a>
				</c:if> <c:if test="${curPage <= 1}">
			 		首页&nbsp;&nbsp;&nbsp;上一页
		 		</c:if> &nbsp;&nbsp;&nbsp; <c:if test="${curPage < maxPage}">
					<a href="Trends.action?op=showcom&jumpPage=${curPage + 1}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">下一页</a>
		 			&nbsp;&nbsp;&nbsp;
		 			<a href="Trends.action?op=showcom&jumpPage=${maxPage}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">尾页</a>
				</c:if> <c:if test="${curPage >= maxPage}">
					下一页
		 			&nbsp;&nbsp;&nbsp;尾页		 		
		 		</c:if>
