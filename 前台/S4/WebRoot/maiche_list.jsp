...
<script type="text/javascript">
 ...
 function(){
  ...
  var price=$("#price").val();
  var emsi=$("#emsi").val()
  var url="CarInfo.action?op=showlist&bname="+brand+"&cser="+ser+"&tname="+tname+"&distance="+distance+"&price="+price+"&age="+age+"&emsi="+emsi+"";
...
function sendSc(c_id,c_uid,nop){
 var url = "<%=basePath%>MemberCenter.action?op="+nop+"&c_id="+c_id+"&c_uid="+c_uid+"&nocahe="+new Date().getTime()+"";
  CreateXMLHttp();
  if(xmlhttp){
     xmlhttp.open("GET",url, true); 
...
alert("留言失败")}
  ...
  <div class="top">
    <div class="wrap clearfix"> <a href="#" class="logo left"><img src="images/logo.png"/></a>
      ...
      <a class="on" href="CarInfo.action?op=showlist">我要买车</a>
...
<c:if test="${!empty userinfo }"> <a id="MemberMenuChange" href="MemberCenter.action?op=showmenber" target="_self">会员中心</a></c:if>
    ...
    ${userinfo.u_name } 
      ...
      </a>|<a  href="UserInfo.action?op=zhuxiao&url=CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price}&distance=${distance}&age=${age}&emsi=${emsi}"  >注销</a>|&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/tel.png"/>			
      </c:if>
      </span> </div>
  </div>
      ...
      <div class="carfl-tit clearfix">
        <div class="result-box left dInline" style="height:auto;"> <span class="left">您的当前选择：</span>
          ...
          <c:if test="${!empty bname }">
                    <div class="s-form left clearfix" style="white-space:normal; width:auto">	<p class="left" style="width:auto;">&nbsp;${bname }<a href="CarInfo.action?op=showlist&tname=${tname}&cser=${cser}&price=${price}&distance=${distance}&age=${age}&emsi=${emsi}"><span class="close right"></span></a>	</p></div>   
          </c:if>
           <c:if test="${!empty tname }">
                    <div class="s-form left clearfix" style="white-space:normal; width:auto">	<p class="left" style="width:auto;">&nbsp;${tname }<a href="CarInfo.action?op=showlist&bname=${bname}&cser=${cser}&price=${price}&distance=${distance}&age=${age}&emsi=${emsi}"><span class="close right"></span></a>	</p></div>   
                     </c:if>
                     <c:if test="${!empty cser }">
                    <div class="s-form left clearfix" style="white-space:normal; width:auto">	<p class="left" style="width:auto;">&nbsp;${cser }<a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname}&price=${price}&distance=${distance}&age=${age}&emsi=${emsi}"><span class="close right"></span></a>	</p></div>   
                     </c:if>
                     <c:if test="${!empty distance }">
                    <div class="s-form left clearfix" style="white-space:normal; width:auto">	<p class="left" style="width:auto;">&nbsp;${distance }<a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price}&age=${age}&emsi=${emsi}"><span class="close right"></span></a>	</p></div>   
                     </c:if>
                     <c:if test="${!empty price }">
                    <div class="s-form left clearfix" style="white-space:normal; width:auto">	<p class="left" style="width:auto;">&nbsp;${price }<a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&distance=${distance}&age=${age}&emsi=${emsi}"><span class="close right"></span></a>	</p></div>   
                     </c:if>
                     <c:if test="${!empty age }">
                    <div class="s-form left clearfix" style="white-space:normal; width:auto">	<p class="left" style="width:auto;">&nbsp;${age }<a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname}&cser=${cser}&price=${price}&distance=${distance}&emsi=${emsi}"><span class="close right"></span></a>	</p></div>   
                     </c:if>
                     <c:if test="${!empty emsi }">
                    <div class="s-form left clearfix" style="white-space:normal; width:auto">	<p class="left" style="width:auto;">&nbsp;${emsi }<a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname}&cser=${cser}&price=${price}&distance=${distance}&age=${age}"><span class="close right"></span></a>	</p></div>   
                     </c:if>
        ...
        <input type="hidden" id="age" value=${age }>
         <c:if test="${!empty userinfo }"><a href="CarInfo.action?op=showsrdz" class="dBtn right">在线私人订制</a></c:if>
        ...
        <ul>
          <li class=""> <span class="c-name left">品牌：</span>
            ...
            <c:forEach var="showbrand" items="${showbrand }">
                        <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${showbrand.value.b_name }&price=${price}&distance=${distance}&age=${age}&emsi=${emsi}" ><img src="${showbrand.value.b_img }" style="height:32px;"/></a>
          ...
          <li class=""> <span class="c-name left">价格：</span>
            ...
            <c:forEach var="priceMap" items="${priceMap }">
             <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${priceMap.value.p_name}&distance=${distance}&age=${age}&emsi=${emsi}" >${priceMap.value.p_name }</a>
            </c:forEach>
            </c:if>
              <div class="pro_smore">
                <div class="clearfix ps-b">
                <form action="CarInfo.action" method="get" onsubmit="return chekSubMi('minPrice','maxPrice','万','_price')">
                  <table>
                    <tr>
                    ...
                    <tr><td> <input type="hidden" name="op" value="showlist" ></td></tr>
                  </table>
                  </form>
                </div>
              </div>
          ...
          <li class="" style="height:48px;"> <span class="c-name left">车型：</span>
            ...
            <c:forEach var="showType" items="${showType }">
             <a href="CarInfo.action?op=showlist&tname=${showType.value.t_name}&bname=${bname }&cser=${cser}&price=${price}&distance=${distance}&age=${age}&emsi=${emsi}"  ><img src="${showType.value.t_class }" height="30"/><br/>
            ${showType.value.t_name }</a>
            </c:forEach>
            </c:if>
     </div>
          </li>
          <li class=""> <span class="c-name left">车龄：</span>
            <div class="spec-moudle left dInline">
             ...
             <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price}&distance=${distance}&age=${ageMap.value.a_name}&emsi=${emsi}"> ${ageMap.value.a_name }</a>
             </c:forEach>
             </c:if> 
              <div class="pro_smore">
                <div class="clearfix ps-b">
                 <form action="CarInfo.action" method="get" onsubmit="return chekSubMi('minAge','maxAge','年','_age')">
                  <table>
                    <tr>
          ...
          <li class=""> <span class="c-name left">里程：</span>
            ...
            <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distanceMap.value.d_name }&age=${age}&emsi=${emsi}">${distanceMap.value.d_name }</a>
            </c:forEach>
            </c:if>
              <div class="pro_smore">
                <div class="clearfix ps-b">
                <form action="CarInfo.action"  method="get"   onsubmit="chekSubMi('minDisTance','maxDisTance','万公里','_distance')">
                  <table>
                    <tr>
          ...
          <li class=""> <span class="c-name left">排放标准：</span>
            ...
            <c:forEach var="emisMap" items="${emisMap }">
             <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age}&emsi=${emisMap.value.e_name}" id="1" >${emisMap.value.e_name }</a>
            </c:forEach>
            </c:if>
        ...
        <div class="cs-tit">
          <div class="clearfix">
            <div class="ctLeft left dInline">
              ...
              <div class="cs_sub"> 排序： <a class="cs-a1" href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age}&emsi=${emsi}">默认<img src="images/down.gif"/></a> <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=c_count">点击量<img src="images/down.gif"/></a> <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=c_sccount">收藏量<img src="images/down.gif"/></a> <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=c_price">价格<img src="images/up.gif"/></a> <a href="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=c_distance">里程<img src="images/up.gif"/></a> </div>
            </div>
            <div class="right cpages"> <c:if test="${curPage > 1}">
		 		<a href="CarInfo.action?op=showlist&jumpPage=${curPage - 1}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">&lt;</a>
        ...
        <div class="cs-list">
          ...
          <c:forEach var="carMap" items="${carMap }">
           <li class="clearfix" style="position: relative;"> <span class="carImg left dInline">
            <a href="CarInfo.action?op=showdetails&uid=${carMap.u_id }&cid=${carMap.c_id }" target="_blank">
              <div class="car_bg"> </div>
              <img src="${carMap.c_img }"  width="300" /></a> </span>
              <div class="carTxt right dInline">
                <h2><a href="CarInfo.action?op=showdetails&uid=${carMap.u_id }&cid=${carMap.c_id }" target="_blank">${carMap.c_brand }${carMap.c_series } ${carMap.c_releaseyear } 款 ${carMap.c_volume }T ${carMap.c_gearType } ${carMap.c_code } ${carMap.c_model }</a></h2>
                <p> <span>上牌时间：${carMap.c_licencetime }</span> <span>行驶里程：${carMap.c_distance }万公里</span> <span>排量：${carMap.c_volume }T</span> <span>排放标准：${carMap.c_emissionstandard }</span> </p>
                <div class="price clearfix" style="margin:8px 0;">
                  <div class="left dInline pNum" style="width:110px;"> <font>一口价</font><br/>
                    <span class="num nBlue">${carMap.c_price } </span><font> 万元</font> </div>
                  <span class="num1 left" style="height:43px; width:450px;padding-top:10px;"><em>新车价：${carMap.newprice }万元</em><br/>
                  为您节省：${carMap.newprice-carMap.c_price }万元 
               ...
               <c:if test="${empty userinfo }"> <a  onclick="sendLogin()"  id="Order_1165">立即抢订</a></c:if>
                 <c:if test="${!empty userinfo }"> <a  onclick="sendDg(${carMap.c_id },${carMap.u_id },'needdg')" id="Order_1165">立即抢订</a></c:if>
                 <a href="CarInfo.action?op=showCompare&uid=${carMap.u_id }&cid=${carMap.c_id }"  class="balance_1165">加入对比</a> 
                 <c:if test="${empty userinfo }"> <a onclick="sendLogin()"  id="collection_1165" >收藏</a></c:if>
                  <c:if test="${!empty userinfo }"> <a onclick="sendSc(${carMap.c_id },${carMap.u_id },'needsc')"  id="collection_1165" >收藏</a></c:if>
                  <span>已有${carMap.c_sccount }人关注此车</span> </div>
              </div>
            </li>
          </c:forEach>
          </c:if>
          ...
          <div class="pages"> <c:if test="${curPage > 1}">
					<a href="CarInfo.action?op=showlist&jumpPage=1&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">首页</a>&nbsp;&nbsp;&nbsp;
		 		<a href="CarInfo.action?op=showlist&jumpPage=${curPage - 1}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">上一页</a>
				</c:if> <c:if test="${curPage <= 1}">
			 		首页&nbsp;&nbsp;&nbsp;上一页
		 		</c:if> &nbsp;&nbsp;&nbsp; <c:if test="${curPage < maxPage}">
					<a href="CarInfo.action?op=showlist&jumpPage=${curPage + 1}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">下一页</a>
		 			&nbsp;&nbsp;&nbsp;
		 			<a href="CarInfo.action?op=showlist&jumpPage=${maxPage}&tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=${order}">尾页</a>
				</c:if> <c:if test="${curPage >= maxPage}">
					下一页
		 			&nbsp;&nbsp;&nbsp;尾页		 		
		 		</c:if>
          ...
          <div class="txtMarquee-top">
            <div class="sameCar bd">
              ...
              <c:forEach var="carMap" items="${carMap }">
               ...
               <li> <a href="CarInfo.action?op=showdetails&cid=${carMap.c_id}&uid=${carMap.u_id } " target="_blank">${carMap.c_brand }${carMap.c_series }${carMap.c_releaseyear }款 ${carMap.c_volume }T ${carMap.c_gearType } ${carMap.c_code } ${carMap.c_model }</a> </li>
              </c:forEach>
              </c:if>
    ...
    <div class="p-detail" >
      <div class="p-dl" id="login" style="display: none"  >
        <form  action="UserInfo.action" method="get" name="form" id="form" onsubmit="return chekLogin('username','userpwd','yzm','_yzm','d1','d2','d3')">
          ...
          <input type="hidden" name="url" value="CarInfo.action?op=showlist&tname=${tname}&bname=${bname }&cser=${cser}&price=${price}&distance=${distance}&age=${age}&emsi=${emsi}">
